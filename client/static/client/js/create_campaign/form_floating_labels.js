...
$(function() {
    ...
    $('.multiselect-campaign-method').multiselect({
      ...
      nonSelectedText: 'Select Outreach Method',
    ...
    $(document).ready(function() {
    $('.multiselect-campaign-method1').multiselect({
    ...
    $(document).ready(function() {
     $('.multiselect-campaign-method2').multiselect({
      ...
      nonSelectedText: 'Select Employee Size',
      onSelectAll: function() {
          $.uniform.update();
      }
    });
    ...
    $(document).ready(function() {
    $('.multiselect-campaign-method3').multiselect({
      ...
      nonSelectedText: 'Select Revenue Size',
      onSelectAll: function() {
          $.uniform.update();
      }
    });
    ...
    $('.multiselect-campaign-company').multiselect({
      ...
      nonSelectedText: 'Select Company  Size',
      onChange: function() {
            $.uniform.update();
        }
    });

    $('.multiselect-campaign-revenue').multiselect({
      includeSelectAllOption: true,
      enableFiltering: true,
      templates: {
          filter: '<li class="multiselect-item multiselect-filter"><i class="icon-search4"></i> <input class="form-control" type="text"></li>'
      },
      nonSelectedText: 'Select Campany Revenue',
      onChange: function() {
            $.uniform.update();
        }
    });

        $('.multiselect-campaign-industry').multiselect({
          ...
          nonSelectedText: 'Select Campany Industry',
          onChange: function() {
                $.uniform.update();
            }
        });
